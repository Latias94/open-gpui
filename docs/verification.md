...
cargo nextest run -p open-gpui-docking transition_pane_clip_mounts_real_pane_content host_unzoom_command_retargets_from_active_zoom_sample dragging_tab_to_other_stack_center_moves_panel transition_plan_between_overlay_scenes_keeps_previous_bounds_for_matching_layers transition_plan_keeps_tab_insertion_layers_at_current_target_bounds --no-fail-fast
```
