...
status: active
timestamp: 2026-07-08T18:55:00+08:00
git_branch: main
related_plan:
...
- Snapshot timestamp: 2026-07-08T18:55:00+08:00.
- Branch: `main`.
- Current work: runtime/docking/core hardening and devtools/form/resource ecosystem work are both integrated locally on `main`; finish the merge commit, run focused post-merge checks, then push `origin/main`.
...
- UI components now include both the first-party `form` helper and ecosystem `form_adapter` / `resource_adapter` helpers.
