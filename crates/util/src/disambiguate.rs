...
mod tests {
    ...
    fn test_duplicate_paths_from_multiple_groups() {
        ...
        // Simulates the sidebar scenario: a path like /Users/rtfeldman/code/open-gpui
        // appears in two project groups (e.g. "open-gpui" alone and "open-gpui, roc").
        // After deduplication, only unique paths should be disambiguated.
        //
        // Paths:
        //   /Users/rtfeldman/code/worktrees/open-gpui/focal-arrow/open-gpui  (group 1)
        //   /Users/rtfeldman/code/open-gpui                                  (group 2)
        //   /Users/rtfeldman/code/open-gpui                                  (group 3, same path as group 2)
        //   /Users/rtfeldman/code/roc                                        (group 3)
        //
        // A naive flat_map collects duplicates. The duplicate /code/open-gpui entries
        ...
        let all_paths: Vec<&Path> = vec![
            Path::new("/Users/rtfeldman/code/worktrees/open-gpui/focal-arrow/open-gpui"),
            Path::new("/Users/rtfeldman/code/open-gpui"),
        ...
        // focal-arrow/open-gpui and code/open-gpui both end in "open-gpui", so they need detail 1.
        // "roc" is unique at detail 0.
        assert_eq!(details, vec![1, 1, 0]);

        assert_eq!(
            path_suffix(all_paths[0], details[0]),
            "focal-arrow/open-gpui"
        );
        assert_eq!(path_suffix(all_paths[1], details[1]), "code/open-gpui");
