...
pub use open_gpui_ui_core::{
    ...
    TableTextFilterOperator, TableTreeRow, VirtualizerItemKey, VirtualizerItemMeasurement,
    VirtualizerRange, VirtualizerResolvedState, VirtualizerSnapshot, VirtualizerSnapshotItem,
    VirtualizerState, drag_table_column_resize, end_table_column_resize, resolve_grid_viewport_2d,
};
pub use open_gpui_ui_core::{
...
pub use table::{
    ...
    TableHeaderAction, TableInputModifiers, TableMetrics, TablePinnedLayoutPlan,
