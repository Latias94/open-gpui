...
pub struct ComboboxMetrics {
    popup_padding: open_gpui::Pixels,
    popup_radius: open_gpui::Pixels,
    popup_min_width: open_gpui::Pixels,
    popup_max_width: open_gpui::Pixels,
    popup_max_height: open_gpui::Pixels,
}
...
impl ComboboxMetrics {
    ...
    pub const fn from_size(size: Size) -> Self {
        Self {
            popup_padding: px(4.0),
            popup_radius: size.control_radius(),
            popup_min_width: px(260.0),
            popup_max_width: px(420.0),
            popup_max_height: match size {
                Size::XSmall => px(180.0),
                Size::Small => px(220.0),
                Size::Medium => px(280.0),
                Size::Large => px(340.0),
            },
        }
    }
    ...
    pub const fn popup_padding(self) -> open_gpui::Pixels {
        self.popup_padding
    }

    /// Returns popup corner radius.
    pub const fn popup_radius(self) -> open_gpui::Pixels {
        self.popup_radius
    }

    /// Returns popup minimum width.
    pub const fn popup_min_width(self) -> open_gpui::Pixels {
        self.popup_min_width
    }

    /// Returns popup maximum width.
    pub const fn popup_max_width(self) -> open_gpui::Pixels {
        self.popup_max_width
    }

    /// Returns popup maximum height.
    pub const fn popup_max_height(self) -> open_gpui::Pixels {
