...
declare_public_exports! {
    ...
    crate::virtualized_list => {
        ...
        VirtualizedListItemDescriptor, VirtualizedListMaterializationResult,
        VirtualizedListMaterializationTarget, VirtualizedListMetrics,
        VirtualizedListRowBehaviorSnapshot, VirtualizedListRowKind, VirtualizedListRowMeasureMode,
        VirtualizedListRowRenderContext, VirtualizedListSelectionChange,
