...
//!
//! To illustrate, consider the body of a trivial application startup callback below. A platform-selected [`Application`](crate::Application) passes the callback a reference to the `App` that owns all application state. This `App` is our gateway to application-level services such as opening windows and presenting dialogs. It also has a `new` method, which is called below to create an entity and give ownership of it to the application.
//!
//! ```no_run
//! # use open_gpui::{App, AppContext, Entity};
//! # struct Counter {
//! #     count: usize,
//! # }
...
//!
//! ```no_run
//! # use open_gpui::{App, AppContext, Context, Entity};
//! # struct Counter {
//! #     count: usize,
//! # }
//! # fn startup(cx: &mut App) {
...
//!
//! ```no_run
//!  # use open_gpui::{App, AppContext, Entity, prelude::*};
//!  # struct Counter {
//!  #     count: usize,
//!  # }
//!  # fn startup(cx: &mut App) {
...
//!
//! ```no_run
//! # use open_gpui::{App, AppContext, Context, Entity, EventEmitter};
//! # struct Counter {
//! #     count: usize,
//! # }
//! # struct CounterChangeEvent {
