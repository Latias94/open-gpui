...
impl DockViewportAdapter {
    ...
    /// that need product close semantics, host-scene publication, and dock-back behavior should
    /// open windows through [`DockViewportRuntimeHandle`](crate::DockViewportRuntimeHandle).
    ///
