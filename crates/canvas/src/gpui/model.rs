...
pub struct CanvasPaintTheme {
    ...
    pub connection_free_target_fill: Hsla,
    pub connection_free_target_stroke: Hsla,
    pub connection_valid_target_fill: Hsla,
    pub connection_valid_target_stroke: Hsla,
    pub connection_invalid_target_fill: Hsla,
    pub connection_invalid_target_stroke: Hsla,
...
impl Default for CanvasPaintTheme {
    fn default() -> Self {
        Self {
            ...
            connection_free_target_fill: Hsla::from(rgb(0x0969da)).alpha(0.12),
            connection_free_target_stroke: Hsla::from(rgb(0x0969da)).alpha(0.7),
            connection_valid_target_fill: Hsla::from(rgb(0x1a7f37)).alpha(0.14),
            connection_valid_target_stroke: Hsla::from(rgb(0x1a7f37)).alpha(0.9),
            connection_invalid_target_fill: Hsla::from(rgb(0xcf222e)).alpha(0.12),
            connection_invalid_target_stroke: Hsla::from(rgb(0xcf222e)).alpha(0.9),
