...
use crate::{
    ...
    CanvasEdgeRenderPolicy, CanvasEdgeRouteKind, CanvasEdgeRouter, CanvasEditor, CanvasEndpoint,
    CanvasEvent, CanvasHandle, CanvasKey, CanvasKeyModifiers, CanvasKindLabel, CanvasKindPaint,
    CanvasKindRegistry, CanvasNode, CanvasNodeGeometryPolicy, CanvasNodeKind,
    CanvasNodeRenderPolicy, CanvasRecordId, CanvasRoutePath, CanvasRouteRequest, CanvasSelection,
    CanvasSelectionMode, CanvasShape, CanvasShapeKind, CanvasShapeRenderPolicy, CanvasSnapAxis,
    CanvasSnapGuide, CanvasStyle, CanvasTransaction, CanvasTransformTarget, CanvasViewport,
    DocumentCommand, EdgeId, HandleRole, HitTarget, PointerButton,
    session::ToolState,
