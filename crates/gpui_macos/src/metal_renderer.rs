...
// Exported to metal
pub(crate) type PointF = open_gpui::Point<f32>;
...
#[cfg(any(test, feature = "test-support"))]
impl open_gpui::PlatformHeadlessRenderer for MetalHeadlessRenderer {
    ...
    fn sprite_atlas(&self) -> Arc<dyn open_gpui::PlatformAtlas> {
